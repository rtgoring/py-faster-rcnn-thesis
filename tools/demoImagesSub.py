...
#CLASSES = ('__background__', 'lighttower','redtower','greentower','yellowtower','blacktower')        
CLASSES = ('__background__', 'gate','redbuoy','greenbuoy','yellowbuoy','path','gateinv','torpedoboard','binbannana','binlightning','bincan','binorange',)
...
if __name__ == '__main__':
    ...
    #imagePath = '/home/goring/Documents/DataSets/Sub/2015/time portal'
    imageFiles = []
    ...
    prototxt = '/home/goring/Documents/py-faster-rcnn/models/pascal_voc/VGG16/faster_rcnn_end2end/test.prototxt'
    #print prototxt
    ...
    caffemodel = '/home/goring/Documents/py-faster-rcnn/output/faster_rcnn_end2end/voc_2007_trainval/vgg16_faster_rcnn_iter_50000.caffemodel'
    #print caffemodel

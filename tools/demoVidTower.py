...
CLASSES =('__background__','bluecircledock','bluetriangledock','blackbuoy','blackball','redbuoy',\
...
if __name__ == '__main__':
    ...
    #videoFilePath = '/home/goring/Desktop/AVI for Rob and Abby/CAM 1 - lighttowerGBY.avi'
    videoFilePath = '/media/goring/Storage7200/hawaii/batch3/CAM 1 - tower4.avi'
    videoFile = cv2.VideoCapture(videoFilePath)
    cv2.namedWindow(videoFilePath.split('/')[len(videoFilePath.split('/'))-1] ,cv2.WINDOW_NORMAL)
    args = parse_args()

    #prototxt = os.path.join(cfg.MODELS_DIR, NETS[args.demo_net][0],
     #                       'faster_rcnn_alt_opt', 'faster_rcnn_test.pt')

    prototxt = '/home/goring/Documents/py-faster-rcnn/models/pascal_voc/VGG16/faster_rcnn_end2end/17/test.prototxt'
    #print prototxt
    ...
    caffemodel = '/home/goring/Documents/py-faster-rcnn/output/faster_rcnn_end2end/voc_2007_trainval/robotXaftertest/vgg16_faster_rcnn_iter_10000.caffemodel'
    #print caffemodel
